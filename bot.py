...
<body>
    <div class="container">
        ...
        <div class="nav-buttons">
            <a href="/conteudos" class="link-button btn-voltar">⬅ Voltar</a>
    ...
    <script>
        async function gerarPix() {
            ...
            if(!nome || !email || !telegram) {
                alert('Por favor, preencha todos os campos (Nome, E-mail e @ do Telegram).');
                return;
            }
    ...
    try:
        ...
        if data and data.get("type") == "payment":
            ...
            if payment_status == "approved":
                payment_description = payment_info["response"].get("description", "")
                payer_email = payment_info["response"].get("payer", {}).get("email")
                
                print(f"==================================================")
                print(f"✅ [PAGAMENTO APROVADO COM SUCESSO!] ID: {payment_id}")
                print(f"📌 Detalhes / Telegram: {payment_description}")
                print(f"📧 E-mail: {payer_email}")
                print(f"==================================================")
