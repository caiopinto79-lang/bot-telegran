...
<body>
    <div class="container">
        ...
        <!-- Botão Instagram com ícone oficial -->
        ...
        <!-- Botão TikTok com ícone oficial -->
        ...
        <!-- Botão Kwai com ícone personalizado -->
        <a href="https://k.kwai.com/u/@mc.iasmin_ofc/z0YdoxCi" target="_blank" class="link-button btn-kwai">
            <svg viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm4.43 17.58h-2.14V9.82c0-.46-.38-.84-.84-.84h-1.68c-.46 0-.84.38-.84.84v7.76H7.57V6.42h2.36v1.14c.58-.8 1.51-1.34 2.58-1.34 1.83 0 3.32 1.49 3.32 3.32v7.96z"/></svg>
            Kwai Oficial
        </a>
