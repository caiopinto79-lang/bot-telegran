...
# Templates embutidos num único ficheiro para facilitar
HTML_INDEX = """
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Acesso Exclusivo - Grupo VIP</title>
    <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0f172a; color: #f8fafc; margin: 0; padding: 0; display: flex; justify-content: center; align-items: center; min-height: 100vh; }
        .container { background-color: #1e293b; padding: 30px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); width: 100%; max-width: 400px; text-align: center; box-sizing: border-box; }
        h1 { font-size: 22px; margin-bottom: 10px; color: #38bdf8; }
        p { color: #94a3b8; font-size: 14px; margin-bottom: 20px; }
        input { width: 100%; padding: 12px; margin-bottom: 15px; border-radius: 6px; border: 1px solid #334155; background: #0f172a; color: #fff; box-sizing: border-box; }
        button { background-color: #0284c7; color: white; border: none; padding: 12px; width: 100%; border-radius: 6px; font-weight: bold; cursor: pointer; transition: background 0.3s; }
        button:hover { background-color: #0ea5e9; }
        #resultado-pix { margin-top: 20px; display: none; }
        textarea { width: 100%; height: 80px; background: #0f172a; color: #38bdf8; border: 1px solid #334155; border-radius: 6px; padding: 8px; font-size: 12px; resize: none; box-sizing: border-box; }
    </style>
</head>
<body>
    <div class="container">
        <h1>Grupo VIP Telegram</h1>
        <p>Garanta seu acesso imediato preenchendo os dados abaixo:</p>
        
        <div id="form-pagamento">
            <input type="text" id="nome" placeholder="Seu Nome Completo" required>
            <input type="email" id="email" placeholder="Seu E-mail" required>
            <button onclick="gerarPix()">Gerar Pagamento Pix</button>
        </div>

        <div id="resultado-pix">
            <p style="color: #34d399; font-weight: bold;">Pix gerado com sucesso!</p>
            <p style="font-size: 12px;">Copie o código abaixo:</p>
...
<body>
    <div class="container">
        ...
        <p>O seu pagamento foi processado com sucesso. O seu acesso ao grupo será enviado em instantes.</p>
    </div>
</body>
</html>
"""
